...
function SpecificWalletTransactionChart() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`https://daostats.onrender.com/token-transfers/${contractAddress}/${walletAddress}`);
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-4 rounded-md w-full max-w-screen-lg shadow-lg">
                <h2 className="text-2xl mb-4 text-center font-semibold">Specific Wallet Transaction</h2>
                ...
                <div className="mb-4">
                    ...
                    />
                    <button className="ml-2 bg-blue-500 text-white p-2 rounded" onClick={fetchData}>Fetch Data</button>
                </div>
